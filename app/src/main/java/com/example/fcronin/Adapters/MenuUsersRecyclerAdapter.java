            ...
            protected FilterResults performFiltering(CharSequence charSequence) {
                ...
                if (charString.isEmpty()) {
                    ...
                    for (User row : dataList) {
                        ...
                        if (toCheckWith.toLowerCase().contains(charString.toLowerCase())) {
...
//            Glide.with(context).load(profileImageUrl).apply(new RequestOptions().placeholder(R.drawable.ic_placeholder)).into(userImage);
            ...
            if (userMe.getBlockedUsersIds() != null && userMe.getBlockedUsersIds().contains(user.getId())) {
                if (status != null) {
                    ...
                    status.setText("Blocked. Tap to unblock");
                }
            } else {
                if (status != null) {
