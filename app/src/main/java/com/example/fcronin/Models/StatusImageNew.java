...
@RealmClass
public class StatusImageNew implements Parcelable, RealmModel {
    ...
    public StatusImageNew(int attachmentType) {
        this.attachmentType = attachmentType;
        this.senderId = "";
    }

    protected StatusImageNew(Parcel in) {
        body = in.readString();
    ...
    public static final Creator<StatusImageNew> CREATOR = new Creator<StatusImageNew>() {
        @Override
        public StatusImageNew createFromParcel(Parcel in) {
            return new StatusImageNew(in);
        }

        @Override
        public StatusImageNew[] newArray(int size) {
            return new StatusImageNew[size];
        }
    };
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof StatusImageNew)) return false;

        StatusImageNew message = (StatusImageNew) o;
