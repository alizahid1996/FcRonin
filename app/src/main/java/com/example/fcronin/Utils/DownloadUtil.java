package com.example.fcronin.Utils;
...
public class DownloadUtil {
    ...
    public void checkAndLoad(Context context, DownloadFileEvent downloadFileEvent) {
        ...
        if (file.exists()) {
            ...
            downloadFile(context, downloadFileEvent.getAttachment().getUrl(), AttachmentTypes.getTypeName(downloadFileEvent.getAttachmentType()),
                    downloadFileEvent.getAttachment().getName());
